...
#     "IMAGE_DESC_EMBEDDING_STORE": "faiss_db/image_desc_faiss_index"
# }


# class ragApproach2:
#     def __init__(self, pdf_docs, chunks, pdf_names, csv_chunks, image_chunks):
#         """
...
#             image_chunks (list): List of text chunks describing images.
#         """
...
#         """
#         Create and save vector stores for document, CSV, and image description embeddings.

#         Returns:
#             bool: True if the stores were created and saved successfully, None otherwise.
#         """
#         try:
#             # Create vector stores for text, CSV, and image description embeddings
#             store = FAISS.from_documents(self.chunks, self.embeddings)
#             csv_store = FAISS.from_documents(self.csv_chunks, self.embeddings)
#             image_description_store = FAISS.from_documents(
#                 self.image_chunks, self.embeddings)
...
#             image_description_store.save_local(
#                 name_constants["IMAGE_DESC_EMBEDDING_STORE"])
...
#         - For Approach 2, description of images is already generated and vectorized.
#         - Just similarity search with the generated answer with image description embeddings and get the most suitable images
#         - Uses functions like:
...
#             image_data = {}
#             if all_image_paths:
#                 image_session = self.call_image_model(answer)
#                 if image_session:
...
#                     system_instruction=v2_answer_retriever_instruction
#                 )
...
#     def call_image_model(self, answer):
#         """
...
#         """
#         try:
#             # Load the image description store
#             image_description_store = FAISS.load_local(
#                 name_constants["IMAGE_DESC_EMBEDDING_STORE"], self.embeddings)

#             # Retrieve similar image descriptions
#             image_description_docs = image_description_store.similarity_search(
#                 answer, k=4)

#             # Format the retrieved image descriptions
#             context_images = [
#                 {
...
#             image_combine_context = json.dumps(context_images)

#             # Prepare the chat session history
#             history_parts = [
#                 f"TEXTUAL CONTEXT: {answer}\nIMAGE CONTEXT: {image_combine_context}"]
